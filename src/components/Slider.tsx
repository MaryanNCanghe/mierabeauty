...
const slides: Slide[] = [
  {
    ...
    title: "Real Hair.\nReal Radiance.",
    subtitle: "Ethically-sourced human hair, crafted for length, movement, and shine that lasts.",
    mediaType: "image",
    img: "https://epptibwjvogadqehnyua.supabase.co/storage/v1/object/public/product-images/decorative/dark-brown-loose-deep-wave.png",
    url: "/shop",
  ...
  },
  {
    ...
    title: "Bundles,\nRedefined.",
    subtitle: "Cuticle-intact, single-donor hair — chosen for women who don't compromise.",
    mediaType: "image",
    img: "https://epptibwjvogadqehnyua.supabase.co/storage/v1/object/public/product-images/decorative/golden-blonde-natural-wave.png",
    url: "/shop?cat=bundles",
    cta: "SHOP BUNDLES",
    bg: "bg-[#0A0A0A]",
  },
  {
    ...
    title: "Find Your\nPerfect Shade.",
    subtitle: "Seven shades, endlessly blendable — discover the one that's already yours.",
    mediaType: "image",
    img: "https://epptibwjvogadqehnyua.supabase.co/storage/v1/object/public/product-images/decorative/chestnut-brown-natural-wave.png",
    url: "/shop",
    cta: "DISCOVER MORE",
    bg: "bg-[#0A0A0A]",
  },
